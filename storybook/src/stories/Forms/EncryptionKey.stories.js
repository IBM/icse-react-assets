...
import { EncryptionKeyForm, IcseModal } from "icse-react-assets";
...
const EncryptionKeyEndpointFormStory = () => {
  function validName(str) {
    const regex = /^[A-z]([a-z0-9-]*[a-z0-9])?$/s;
    if (str) return str.match(regex) !== null;
    else return false;
...
const EncryptionKeyModalFormStory = () => {
  function validName(str) {
    const regex = /^[A-z]([a-z0-9-]*[a-z0-9])?$/s;
    if (str) return str.match(regex) !== null;
    else return false;
...
export const Endpoint = EncryptionKeyEndpointFormStory.bind({});
export const Modal = EncryptionKeyModalFormStory.bind({});
