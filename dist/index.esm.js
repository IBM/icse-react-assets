...
class CbrZoneForm extends Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      ,
      onChange: this.handleInputChange
    }, forms_3("account_id", this.state.account_id)))), /*#__PURE__*/React.createElement(IcseFormGroup, null, /*#__PURE__*/React.createElement(TextArea, {
...
class LogDNAForm extends Component {
  ...
  handleInputChange(event) {
    ...
    if (contains$2(["plan", "endpoints"], name)) value = kebabCase$5(value);
    this.setState(this.setNameToValue(name, value));
  }
