...
IamAccountSettingsForm.propTypes = {
  data: PropTypes.shape({
    ...
    restrict_create_service_id: PropTypes.oneOf(restrictMenuItems.forEach(item => {
      return iamItems[item].value;
    })),
    restrict_create_platform_apikey: PropTypes.oneOf(restrictMenuItems.forEach(item => {
      return iamItems[item].value;
    })),
