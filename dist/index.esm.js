...
class VpnServerForm extends Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(IcseFormGroup, null, /*#__PURE__*/React.createElement(IcseNameInput, {
      ...
      name: "subnet",
      labelText: "Subnet",
      groups: isNullOrEmptyString$3(this.state.vpc) ? [] : this.getSubnetList(),
      value: this.state.subnet,
      handleInputChange: this.handleInputChange,
      invalid: lib_4(this.state.subnet),
      invalidText: isNullOrEmptyString$3(this.state.vpc) ? "Select a VPC." : "Select at least one subnet.",
      className: classNameModalCheck
    }), /*#__PURE__*/React.createElement(SecurityGroupMultiSelect, {
      key: this.state.vpc + "-sg",
