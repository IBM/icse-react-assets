...
const IcseHeading = props => {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    id: props.name,
    innerForm: () => {
      return props.type === "subHeading" ? /*#__PURE__*/React__default["default"].createElement("h5", null, props.name) : props.type === "p" ? /*#__PURE__*/React__default["default"].createElement("p", {
...
const PageNotFound = () => {
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: "underConstruction flexDirectionColumn"
  }, /*#__PURE__*/React__default["default"].createElement(iconsReact.Help, {
    size: "128"
  }), /*#__PURE__*/React__default["default"].createElement("h1", null, " ERROR 404"), /*#__PURE__*/React__default["default"].createElement("br", null), /*#__PURE__*/React__default["default"].createElement("h4", null, "Unfortunately, we couldn\u2019t find the page you were looking for, but here are some helpful places to start from:"), /*#__PURE__*/React__default["default"].createElement("br", null), /*#__PURE__*/React__default["default"].createElement("div", {
    className: "kerning"
  }, "Projects", /*#__PURE__*/React__default["default"].createElement("a", {
    href: "localhost:3000/projects",
    target: "_blank"
  }), "Projects", /*#__PURE__*/React__default["default"].createElement("br", null), "About", /*#__PURE__*/React__default["default"].createElement("a", {
    href: "localhost:3000/docs/about",
    target: "_blank"
  }), "About", /*#__PURE__*/React__default["default"].createElement("br", null), "Tutorial", /*#__PURE__*/React__default["default"].createElement("a", {
...
class AtrackerForm extends React.Component {
  ...
  render() {
    ...
    })), this.state.instance && /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseSelect, {
      name: "resource_group",
...
class TransitGatewayForm extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseTextInput, {
      ...
      initialSelectedItems: lazyZ.splat(
      ...
      initialSelectedItems: lazyZ.splat(this.state.connections.filter(connection => {
        if (connection.power) return connection;
      }), "power"),
      items: lazyZ.splat(this.props.power.filter(workspace => {
        if (lazyZ.contains(this.props.edgeRouterEnabledZones, workspace.zone)) return workspace;
      }), "name")
    })), /*#__PURE__*/React__default["default"].createElement(IcseHeading, {
...
class VpeForm extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React__default["default"].createElement("div", null, /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseNameInput, {
      ...
      className: "fieldWidthSmaller"
    })), this.state.service === "secrets-manager" && /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, {
      noMarginBottom: true
    }, /*#__PURE__*/React__default["default"].createElement(IcseSelect, {
...
class VpnServerForm extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseNameInput, {
      ...
      handleInputChange: this.handleInputChange,
      className: "fieldWidthSmaller",
      disableInvalid: lazyZ.isEmpty(this.state.additional_prefixes)
    }), /*#__PURE__*/React__default["default"].createElement(react.TextArea, {
      className: "textInputMedium",
...
VpnServerForm.propTypes = {
  data: PropTypes__default["default"].shape({
    ...
    additional_prefixes: PropTypes__default["default"].arrayOf(PropTypes__default["default"].string)
  }).isRequired,
  /* bools */
  isModal: PropTypes__default["default"].bool.isRequired,
  /* lists */
...
const PowerVsAffinity = props => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseSelect, {
  ...
  }), props.stateData.storage_option === "Storage Type" && /*#__PURE__*/React__default["default"].createElement(IcseSelect, {
    labelText: "Storage Type",
    name: volumeTypeFieldName,
    formName: props.data.name + "-power-instance-stortype",
    groups: ["Tier-1", "Tier-3"],
    value: lazyZ.isNullOrEmptyString(props.stateData[volumeTypeFieldName]) ? "" : lazyZ.capitalize(props.stateData[volumeTypeFieldName].split(/(?=\d)/).join("-")),
    handleInputChange: props.handleInputChange,
    invalidText: "Select a Storage Type.",
    className: "fieldWidthSmaller",
    id: `${props.data.name}-power-instance-stortype`,
    disabled: props.affinityChangesDisabled(props.stateData, props.componentProps)
  }), props.stateData.storage_option === "Storage Pool" && /*#__PURE__*/React__default["default"].createElement(IcseSelect, {
    ...
    disabled: props.affinityChangesDisabled(props.stateData, props.componentProps)
  }), lazyZ.contains(["Affinity", "Anti-Affinity"], props.stateData.storage_option) && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(IcseSelect, {
    labelText: "Affinity Type",
    name: "affinity_type",
    formName: props.data.name + "-power-instance-affinity-type",
    groups: ["Instance", "Volume"],
    value: lazyZ.isNullOrEmptyString(props.stateData.affinity_type) ? "" : props.stateData.affinity_type,
    handleInputChange: props.handleInputChange,
    invalidText: "Select Instance or Volume for boot volume affinity",
    className: "fieldWidthSmaller",
    id: `${props.data.name}-power-affinity-type`,
    disabled: props.affinityChangesDisabled(props.stateData, props.componentProps)
  }), props.stateData.affinity_type && /*#__PURE__*/React__default["default"].createElement(IcseSelect, {
    groups: props.stateData.affinity_type === "Instance" ? lazyZ.splat(props.power_instances.filter(props.instanceFilter), "name") : lazyZ.splat(props.power_volumes.filter(props.volumeFilter), "name"),
    ...
    name: lazyZ.snakeCase(`pi ${props.stateData.storage_option} ${props.stateData.affinity_type}`),
    handleInputChange: props.handleInputChange,
    ...
    value: lazyZ.isNullOrEmptyString(props.stateData[lazyZ.snakeCase(`pi ${props.stateData.storage_option} ${props.stateData.affinity_type}`)]) ? "" : props.stateData[lazyZ.snakeCase(`pi ${props.stateData.storage_option} ${props.stateData.affinity_type}`)],
    className: "fieldWidthSmaller",
    disabled: props.affinityChangesDisabled(props.stateData, props.componentProps)
  })));
};
PowerVsAffinity.propTypes = {
  ...
  stateData: PropTypes__default["default"].shape({
    pi_health_status: PropTypes__default["default"].string,
    storage_option: PropTypes__default["default"].string,
    zone: PropTypes__default["default"].string.isRequired,
    pi_storage_pool: PropTypes__default["default"].string,
    storage_option: PropTypes__default["default"].string,
    affinity_type: PropTypes__default["default"].string
  }).isRequired,
  handleInputChange: PropTypes__default["default"].func.isRequired,
  affinityChangesDisabled: PropTypes__default["default"].func.isRequired,
  componentProps: PropTypes__default["default"].shape({}).isRequired,
  ...
  instanceFilter: PropTypes__default["default"].func.isRequired,
  power_volumes: PropTypes__default["default"].arrayOf(PropTypes__default["default"].shape({})).isRequired,
  volumeFilter: PropTypes__default["default"].func.isRequired
};
...
class PowerVsInstanceForm extends React__default["default"].Component {
  ...
  handleInputChange(event) {
    ...
    if (name === "workspace") {
      ...
      this.setState({
        ...
        if (this.state.pi_health_status === "WARNING" && !lazyZ.contains(["Storage Type", "Storage Pool"], this.state.storage_option)) {
          this.setState({
            storage_option: null,
            affinity_type: null,
      ...
      if (lazyZ.contains(["Affinity", "Anti-Affinity"], value)) {
  ...
  instanceFilter(instance) {
    if (instance.name !== this.props.data.name && (!instance.pi_affinity_policy || lazyZ.isNullOrEmptyString(instance.pi_affinity_policy)) && (!instance.pi_anti_affinity_policy || lazyZ.isNullOrEmptyString(instance.pi_anti_affinity_policy)) && instance.zone === this.state.zone && instance.workspace === this.state.workspace) {
      return instance;
    }
  }
  volumeFilter(volume) {
  ...
  render() {
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseNameInput, {
      ...
      name: "Boot Volume",
      type: "subHeading"
    }), /*#__PURE__*/React__default["default"].createElement(PowerVsAffinity, {
      data: this.props.data,
...
class PowerVsVolumeForm extends React__default["default"].Component {
  ...
  instanceFilter(instance) {
    if ((!instance.pi_affinity_policy || lazyZ.isNullOrEmptyString(instance.pi_affinity_policy)) && (!instance.pi_anti_affinity_policy || lazyZ.isNullOrEmptyString(instance.pi_anti_affinity_policy)) && instance.zone === this.state.zone && instance.workspace === this.state.workspace) {
      return instance;
    }
  }
  volumeFilter(volume) {
...
class OpaqueIngressSecretForm extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseNameInput, {
      ...
      isModal: this.props.isModal
    })), this.state.auto_rotate ? /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(react.NumberInput, {
...
OpaqueIngressSecretForm.propTypes = {
  ...
  labelsInvalidText: PropTypes.PropTypes.string,
  descriptionRegex: PropTypes.PropTypes.instanceOf(RegExp).isRequired
};
...
const OpaqueIngressSecret = props => {
  return props.isModal ? "" : /*#__PURE__*/React__default["default"].createElement(IcseFormTemplate, {
    ...
    onSubmit: props.onSubmit,
    propsMatchState: props.propsMatchState,
    hideFormTitleButton: lazyZ.isEmpty(props.secretsManagerList),
    overrideTile: lazyZ.isEmpty(props.secretsManagerList) ? /*#__PURE__*/React__default["default"].createElement(NoSecretsManagerTile, {
