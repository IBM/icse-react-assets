...
var forms_1 = forms.services;
var forms_2 = forms.serviceGroups;
var forms_3 = forms.vpeVpcDropdown;
var forms_4 = forms.vpeServiceDropdown;
var forms_5 = forms.vpnRouteInputChange;
var forms_6 = forms.handleSubnetTierToggle;
var forms_7 = forms.parseZoneStrings;
var forms_8 = forms.handleSelectZones;
var forms_12 = forms.cbrInvalid;
var forms_15 = forms.handleRuleInputChange;
var forms_22 = forms.handleDnsResolverInputChange;
var forms_23 = forms.dnsFormInputChange;
var forms_24 = forms.atrackerInputChange;
var forms_25 = forms.handleRgToggle;
var forms_26 = forms.handleCRNs;
var forms_27 = forms.handleVpcSelect;
var forms_28 = forms.getRuleProtocol;
var forms_29 = forms.getSubRule;
var forms_30 = forms.swapArrayElements;
var forms_31 = forms.getOrderCardClassName;
var forms_33 = forms.onCheckClick;
var forms_34 = forms.handleVpnServerInputChange;
var forms_35 = forms.vpnServerRangeInvalid;
...
class NetworkingRulesOrderCard extends React.Component {
  ...
  handleUp(index) {
    ...
    if (index !== 0) {
      forms_30(prevRulesState, index, index - 1);
    }
  ...
  render() {
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(IcseHeading, {
      ...
      data: {
        ...
        ruleProtocol: forms_28(rule),
        rule: forms_29(rule, this.props.isSecurityGroup)
      },
...
class ResourceGroupForm extends React.Component {
   ...
   */
  handleToggle(name) {
    this.setState(forms_25(this.state, name));
  }
...
class SubnetTierForm extends React__default["default"].Component {
  ...
  handleSelectZones(event) {
    this.setState(forms_8(event, this.state));
  }
  ...
  handleSubnetTierToggle(name) {
    this.setState(forms_6(name, this.state));
  }
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement(IcseSubForm, {
      ...
      items: ["1", "2", "3"],
      initialSelectedItems: forms_7(this.state, this.props),
...
class TransitGatewayForm extends React.Component {
  ...
  handleVpcSelect(selectedItems) {
    this.setState(forms_27(selectedItems, this.state.name));
  }
  render() {
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseTextInput, {
      onChange: this.handleInputChange,
...
class VpeForm extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React__default["default"].createElement("div", null, /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseNameInput, {
      ...
      groups: forms_2,
      value: forms_1[this.state.service],
...
class VpnServerForm extends React.Component {
   ...
   */
  handleInputChange(event) {
    this.setState(forms_34(this.state, event));
  }
  handleMultiSelectChange(name, value) {
    this.setState(this.setNameToValue(name, value));
  }
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(IcseNameInput, {
      ...
      min: 1,
      max: 65535,
      invalid: forms_35(this.state.port, 1, 65535),
      ...
      min: 0,
      max: 28800,
      invalid: forms_35(this.state.client_idle_timeout, 0, 28800),
...
class CbrZoneForm extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      ,
      onChange: this.handleInputChange
    }, forms_12("account_id", this.state.account_id)))), /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(react.TextArea, {
...
class SecretsManagerChecklist extends React__default["default"].Component {
  ...
  onCheckClick(ref) {
    let selected = forms_33(this.state.selected, ref, this.props.secrets);
    this.setState({
      selected: selected
    }, () => {
