...
class NetworkingRulesOrderCard extends React.Component {
  ...
  render() {
    ...
    }), this.state.showTable ? /*#__PURE__*/React__default["default"].createElement(OrderCardDataTable, {
      isSecurityGroup: this.props.isSecurityGroup,
...
class CbrZoneForm extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      ,
      onChange: this.handleInputChange
    }, forms_10("account_id", this.state.account_id)))), /*#__PURE__*/React__default["default"].createElement(IcseFormGroup, null, /*#__PURE__*/React__default["default"].createElement(react.TextArea, {
