...
var css_248z$2 = ".edit-margin-right {\n  margin-right: 1rem;\n}\n\n.cursor-pointer {\n  cursor: pointer;\n}\n";
...
class NetworkingRulesOrderCard extends React.Component {
  ...
  getRuleData(name) {
    let rule = {
      ...lazyZ.getObjectFromArray(this.props.rules, "name", name)
    }; // copy
    rule.ruleProtocol = forms_20(rule); // get protocol
    rule.rule = forms_21(rule); // get sub rule from data
    delete rule.icmp;
    delete rule.tcp;
    delete rule.udp;
    return rule;
